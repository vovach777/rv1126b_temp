...
typedef enum {
    ...
    ROCKIVA_OBJECT_TYPE_MOTORCYCLE_HEAD = 12,       /* 电瓶车车头 */
    ROCKIVA_OBJECT_TYPE_MOTORCYCLE_TAIL = 13,       /* 电瓶车车尾 */
    ROCKIVA_OBJECT_TYPE_MOTORCYCLE_BODY = 14,       /* 电瓶车车身 */
...
typedef enum {
    ...
    ROCKIVA_DET_MODEL_MHTB            /* 检测类别：电瓶车车头、车尾、车身 */
} RockIvaDetModel;
