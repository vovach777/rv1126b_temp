...
static void gallery_create_ctrl(lv_obj_t *page_obj) {
	...
	lv_obj_align_to(cont_obj, gallery_ctx.exit_obj, LV_ALIGN_OUT_BOTTOM_LEFT, 0, -30);
	...
	gallery_ctx.video_icon_obj = label_obj = lv_label_create(btn_obj);
	...
	gallery_ctx.photo_icon_obj = label_obj = lv_label_create(btn_obj);
	...
	lv_obj_add_event_cb(btn_obj, btn_event_handler, LV_EVENT_DEFOCUSED, (void *)RK_SLOW_MOTION_MODE);
	lv_obj_set_size(btn_obj, lv_pct(30), lv_pct(30));
	gallery_ctx.slowmotion_label_obj = label_obj = lv_label_create(btn_obj);
	gallery_ctx.slowmotion_icon_obj = label_obj = lv_label_create(btn_obj);
	...
	gallery_ctx.timelapse_icon_obj = label_obj = lv_label_create(btn_obj);
}
	
static void gallery_layout(void) {
	lv_obj_set_flex_flow(gallery_ctx.container_obj, LV_FLEX_FLOW_ROW);
	lv_obj_set_flex_align(gallery_ctx.container_obj, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
...
static void gallery_set_text(void) {
	static lv_style_t text_style, icon_style, btn_style, btn_focus_style
		, symbol_style, symbol_focus_style;
	...
	lv_style_set_text_font(&text_style, ttf_info_12.font);
	...
	lv_style_set_pad_bottom(&icon_style, 5);
	...
	lv_obj_add_style(gallery_ctx.exit_obj, &symbol_focus_style, LV_STATE_FOCUS_KEY);

	lv_obj_add_style(gallery_ctx.video_btn_obj, &btn_style, 0);
	lv_obj_add_style(gallery_ctx.video_btn_obj, &btn_focus_style, LV_STATE_FOCUS_KEY);
	lv_label_set_text(gallery_ctx.video_icon_obj, LV_SYMBOL_VIDEO);
	lv_obj_add_style(gallery_ctx.video_icon_obj, &icon_style, 0);
	...
	lv_obj_add_style(gallery_ctx.photo_btn_obj, &btn_focus_style, LV_STATE_FOCUS_KEY);
	lv_label_set_text(gallery_ctx.photo_icon_obj, LV_SYMBOL_IMAGE);
	lv_obj_add_style(gallery_ctx.photo_icon_obj, &icon_style, 0);
	...
	lv_obj_add_style(gallery_ctx.slowmotion_btn_obj, &btn_focus_style, LV_STATE_FOCUS_KEY);
	lv_label_set_text(gallery_ctx.slowmotion_icon_obj, LV_SYMBOL_VIDEO);
	lv_obj_add_style(gallery_ctx.slowmotion_icon_obj, &icon_style, 0);
	...
	lv_obj_add_style(gallery_ctx.timelapse_btn_obj, &btn_focus_style, LV_STATE_FOCUS_KEY);
	lv_label_set_text(gallery_ctx.timelapse_icon_obj, LV_SYMBOL_VIDEO);
	lv_obj_add_style(gallery_ctx.timelapse_icon_obj, &icon_style, 0);
