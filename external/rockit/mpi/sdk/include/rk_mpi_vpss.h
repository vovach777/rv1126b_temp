...
RK_S32 RK_MPI_VPSS_EnableBufferShare(VPSS_GRP VpssGrp, VPSS_CHN VpssChn, MPP_CHN_S stShareBufChn);
...
RK_S32 RK_MPI_VPSS_SetChnWrapBufAttr(VPSS_GRP VpssGrp, VPSS_CHN VpssChn, const VPSS_CHN_BUF_WRAP_S *pstChnWrap);
