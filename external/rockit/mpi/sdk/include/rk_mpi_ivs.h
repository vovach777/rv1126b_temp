...
RK_S32 RK_MPI_IVS_SetComboAttr(IVS_CHN IvsChn, IVS_COMBO_ATTR_S *pstComboAttr);
RK_S32 RK_MPI_IVS_GetComboAttr(IVS_CHN IvsChn, IVS_COMBO_ATTR_S *pstComboAttr);
